...
// Ejemplo de uso
async function testAnalyzer(idElement) {
	const result = await determineResultingStyle(
		idElement, // ID del elemento
		"components/stage-1/challenge-1/challenge-1.html", // Archivo HTML
		"components/stage-1/challenge-1/challenge-1.css", // Archivo CSS
		"color" // Propiedad a analizar
	);
...
testAnalyzer("important");
testAnalyzer("inlinestyles");
